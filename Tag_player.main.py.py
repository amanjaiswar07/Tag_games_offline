...
-------------------------------------------
HOW TO PLAY:
  - One player is the "Chaser" (tries to tag the other)
  - The other player is the "Runner" (tries to escape)
  - Tag the other player → swap roles + score a point!
  - Most tags in 60 seconds WINS!
  - Tie = Sudden Death overtime (first tag wins!)

POWER CUBES (collect them by walking over them):
  ⚡ SPEED  (Yellow) — Move 2x faster for 5 seconds
  🛡 SHIELD (Cyan)   — Cannot be tagged for 4 seconds
  👻 GHOST  (Pink)   — Walk through obstacles for 4 seconds
  🔄 SWAP   (Orange) — Instantly swap who is the chaser!
